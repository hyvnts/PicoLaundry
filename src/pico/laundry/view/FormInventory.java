...
public class FormInventory extends javax.swing.JDialog {
    public FormInventory(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(3, 80, 199));
        ...
        jLabel1.setText("FORM INVENTORY PERSEDIAAN");
        ...
        jLabel5.setText("Harga Per produk");
        ...
        jButton2.setForeground(new java.awt.Color(3, 80, 199));
        jButton2.setText("Simpan");

        jButton3.setForeground(new java.awt.Color(3, 80, 199));
        jButton3.setText("Lihat Inventory");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormInventory dialog = new FormInventory(new javax.swing.JFrame(), true);
